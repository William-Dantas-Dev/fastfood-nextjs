    ...
    return (
        <nav className="bg-white shadow-md py-4 px-6 lg:px-32 md:px-10 fixed top-0 left-0 w-full z-50">
            <div className="flex items-center justify-between">
                <div className="text-2xl font-bold text-red-500">FoodHive</div>
                ...
                <ul className={`md:flex md:space-x-0 space-y-4 md:space-y-0 ${isOpen ? 'fixed top-16 right-0 bg-white w-full shadow-md z-40' : 'hidden'} transition-transform transform ${isOpen ? 'translate-x-0' : 'translate-x-full'} md:translate-x-0 md:relative md:flex-row md:space-y-0 md:bg-transparent md:shadow-none`}>
                    ...
                    <li><a href="#" className="block px-4 py-2 text-gray-600 hover:text-red-500">Offer</a></li>
                    <li><a href="#" className="block px-4 py-2 text-gray-600 hover:text-red-500">Service</a></li>
                    <li><a href="#" className="block px-4 py-2 text-gray-600 hover:text-red-500">Menu</a></li>
                    <li><a href="#" className="block px-4 py-2 text-gray-600 hover:text-red-500">About Us</a></li>
